      ...
      <>
        {isLoggedIn ? (
          <button
            ...
            title={`Ver palpites de ${name}`}
          >
            <Avatar name={name} userId={userId} size={avatarSize} className="mt-2 transition group-hover:ring-accent-400" />
          ...
          <div className={`flex w-full flex-col items-center text-center ${className}`}>
            <Avatar name={name} userId={userId} size={avatarSize} className="mt-2" />
      ...
      <div className={`flex min-w-0 items-center gap-3 ${className}`}>
        {isLoggedIn ? (
          <button
            ...
            title={`Ver palpites de ${name}`}
          >
            <Avatar name={name} userId={userId} size={avatarSize} />
          </button>
        ) : (
          <Avatar name={name} userId={userId} size={avatarSize} />
        )}
